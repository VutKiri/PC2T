    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            switch (volba) {
                ...
                case 9:
                    System.out.print("Zadaj ID študenta na uloženie: ");
                    int idSave = scanner.nextInt();
                    db.ulozStudentaDoSuboru(idSave);
                    break;

                case 10:
                    System.out.print("Zadaj ID študenta na načítanie: ");
                    int idLoad = scanner.nextInt();
                    db.nacitajStudentaZoSuboru(idLoad);
                    break;
